...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 1: Galpón industrial de acero\\(tipología de estudio). Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 2: Elevaciones planos de maestranza. Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 3: Vista general de la Nave~F. Elaboración propia.}\\[2mm]
  \includegraphics[width=0.7\linewidth,height=2.5cm,keepaspectratio]%
    {slide13_fig04.png}\\[1mm]
  {\scriptsize Figura 4: Ubicación (Maipú). Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{center}
  ...
  {\scriptsize Figura 5: Planta de ejes --- 10 marcos, separación 10~m (1.\textsuperscript{er} vano 6,5~m; último 7~m). Elaboración propia.}
\end{center}
\vspace{1mm}
\begin{center}
  \includegraphics[width=0.65\textwidth,height=2.2cm,keepaspectratio]%
    {slide14_fig06.png}\\[1mm]
  {\scriptsize Figura 6: Elevación transversal tipo --- hombro 7,53~m, cumbrera 8,85~m; dos aguas ($\theta \approx 3{,}02^\circ$). Elaboración propia.}
\end{center}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 7: Modelo de la Nave F (Metalpar). Elaboración propia.}\\[2mm]
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 12: Modelo SAP2000 --- vista 3D. Elaboración propia.}\\[1mm]
  \includegraphics[width=\linewidth,height=2.0cm,keepaspectratio]%
    {slide16_img7.png}\\[1mm]
  {\scriptsize Figura 13: Elevación transversal del modelo. Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.8cm,keepaspectratio]%
    {fig02.png}\\[1mm]
  {\scriptsize Figura 14: Presión $q$ vs altura (campo abierto / ciudad). Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 16: Presiones netas sobre la Nave~F\\(NCh432:2025). Elaboración propia.}
  \column{0.52\textwidth}
  \centering\vspace{-2mm}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.0cm,keepaspectratio]%
    {fig04.png}\\[1mm]
  {\scriptsize Figura 19: Espectro de diseño NCh2369.Of2003\\(sitio de Maipú). Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.0cm,keepaspectratio]%
    {fig05.png}\\[1mm]
  {\scriptsize Figura 20: Espectro de diseño NCh2369:2025. Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 21: Espectros NCh2369 Of.2003 vs 2025 generados a partir de los datos SAP2000. Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wx.png}\\[1.5mm]
  {\scriptsize Figura 22: Cargas puntuales por marco --- viento $\perp$ cara corta ($W_x$); zonas Z1--Z4 según $h$. Elaboración propia.}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wy.png}\\[1.5mm]
  {\scriptsize Figura 23: Cargas distribuidas por marco --- viento $\perp$ cara larga ($W_y$); zonas NCh432:2025. Elaboración propia.}
\end{center}
\end{frame}
...
\begin{center}
  ...
  En Zona III-A: \alert{$51{,}00$\,kgf/m$^2$} ($-23\,\%$). Elaboración propia.}
\end{center}
\end{frame}
