...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.8cm,keepaspectratio]%
    {fig02.png}\\[1mm]
  {\scriptsize Figura 14: Presión $q$ vs altura (campo abierto / ciudad).}
\end{columns}
\end{frame}
...
\begin{center}
  \includegraphics[width=0.80\linewidth,height=0.74\textheight,keepaspectratio]%
    {nch71_fig9.png}\\[1mm]
  {\scriptsize Figura 15: Coeficientes de forma sobre cubiertas (Anexo Fig. 9, NCh432.Of1971).}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wx.png}\\[1.5mm]
  {\scriptsize Figura 22: Cargas puntuales por marco --- viento $\perp$ cara corta ($W_x$); zonas Z1--Z4 según $h$.}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wy.png}\\[1.5mm]
  {\scriptsize Figura 23: Cargas distribuidas por marco --- viento $\perp$ cara larga ($W_y$); zonas NCh432:2025.}
\end{center}
\end{frame}
...
\begin{center}
  ...
  En Zona III-A: \alert{$51{,}00$\,kgf/m$^2$} ($-23\,\%$).}
\end{center}
\end{frame}
