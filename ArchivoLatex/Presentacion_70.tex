...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 1: Galpón industrial de acero\\(tipología de estudio). Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 2: Elevaciones planos de maestranza. Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 3: Vista general de la Nave~F. Fuente: Elaboración propia.}\\[2mm]
  \includegraphics[width=0.7\linewidth,height=2.5cm,keepaspectratio]%
    {slide13_fig04.png}\\[1mm]
  {\scriptsize Figura 4: Ubicación (Maipú). Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{center}
  ...
  {\scriptsize Figura 5: Planta de ejes --- 10 marcos, separación 10~m (1.\textsuperscript{er} vano 6,5~m; último 7~m). Fuente: Elaboración propia.}
\end{center}
\vspace{1mm}
\begin{center}
  \includegraphics[width=0.65\textwidth,height=2.2cm,keepaspectratio]%
    {slide14_fig06.png}\\[1mm]
  {\scriptsize Figura 6: Elevación transversal tipo --- hombro 7,53~m, cumbrera 8,85~m; dos aguas ($\theta \approx 3{,}02^\circ$). Fuente: Elaboración propia.}
\end{center}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 7: Modelo de la Nave F (Metalpar). Fuente: Elaboración propia.}\\[2mm]
  \includegraphics[width=0.6\linewidth,height=1.8cm,keepaspectratio]%
    {slide15_fig08.png}\\[1mm]
  {\scriptsize Figura 8: Registro fotográfico - riostras y pilares. Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 9: Planta construida (P2 en rojo). Fuente: Elaboración propia.}\\[0mm]
  \includegraphics[width=\linewidth,height=1.4cm,keepaspectratio]%
    {slide16_fig10.png}\\[1mm]
  {\scriptsize Figura 10: Elevación A-G (PT2 en rojo). Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=4.0cm,keepaspectratio]%
    {fig_lt01.png}\\[1mm]
  {\scriptsize Figura 11: Sistema resistente identificado\\en terreno. Fuente: Elaboración propia.}
  \column{0.55\textwidth}
  \vspace{1mm}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 12: Modelo SAP2000 --- vista 3D. Fuente: Elaboración propia.}\\[1mm]
  \includegraphics[width=\linewidth,height=2.0cm,keepaspectratio]%
    {slide16_img7.png}\\[1mm]
  {\scriptsize Figura 13: Elevación transversal del modelo. Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.8cm,keepaspectratio]%
    {fig02.png}\\[1mm]
  {\scriptsize Figura 14: Presión $q$ vs altura (campo abierto / ciudad). Fuente: Elaboración propia.}
\end{columns}
\end{frame}

%------------------------------------------------------------------
% 17b. VIENTO — NCh432.Of1971 (COEFICIENTES DE FORMA)
%------------------------------------------------------------------
\begin{frame}
\ctitle{VIENTO --- NCh432.Of1971: COEFICIENTES DE FORMA}
\vspace{1mm}
\begin{center}
  \includegraphics[width=0.80\linewidth,height=0.74\textheight,keepaspectratio]%
    {nch71_fig9.png}\\[1mm]
  {\scriptsize Figura 15: Coeficientes de forma sobre cubiertas (Anexo Fig. 9, NCh432.Of1971). Fuente: NCh432.Of1971.}
\end{center}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 16: Presiones netas sobre la Nave~F\\(NCh432:2025). Fuente: Elaboración propia.}
  \column{0.52\textwidth}
  \centering\vspace{-2mm}
  \includegraphics[width=\linewidth,height=4.8cm,keepaspectratio]%
    {nch25_fig4_1.png}\\[1mm]
  {\scriptsize Figura 17: Coeficientes de presión externa $C_p$,\\SPRFV (Fig. 4, NCh432:2025). Fuente: NCh432:2025.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.0cm,keepaspectratio]%
    {fig04.png}\\[1mm]
  {\scriptsize Figura 19: Espectro de diseño NCh2369.Of2003\\(sitio de Maipú). Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.0cm,keepaspectratio]%
    {fig05.png}\\[1mm]
  {\scriptsize Figura 20: Espectro de diseño NCh2369:2025. Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 21: Espectros NCh2369 Of.2003 vs 2025 generados a partir de los datos SAP2000. Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
%------------------------------------------------------------------
% 21b. VIENTO — PRESIONES DE DISEÑO NCh432.Of1971
%------------------------------------------------------------------
\begin{frame}
...
%------------------------------------------------------------------
% 21c. VIENTO — PRESIONES DE DISEÑO NCh432:2025
%------------------------------------------------------------------
\begin{frame}
...
%------------------------------------------------------------------
% 21d. VIENTO — CARGAS POR MARCO Wx (NCh432:2025)
%------------------------------------------------------------------
\begin{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wx.png}\\[1.5mm]
  {\scriptsize Figura 22: Cargas puntuales por marco --- viento $\perp$ cara corta ($W_x$); zonas Z1--Z4 según $h$. Fuente: Elaboración propia.}
\end{center}
\end{frame}

%------------------------------------------------------------------
% 21e. VIENTO — CARGAS POR MARCO Wy (NCh432:2025)
%------------------------------------------------------------------
\begin{frame}
\ctitle{VIENTO --- CARGAS POR MARCO (NCh432:2025)}
\vspace{2mm}
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wy.png}\\[1.5mm]
  {\scriptsize Figura 23: Cargas distribuidas por marco --- viento $\perp$ cara larga ($W_y$); zonas NCh432:2025. Fuente: Elaboración propia.}
\end{center}
\end{frame}

%------------------------------------------------------------------
% 22a. VIENTO — ZONIFICACIÓN (gráfico)
%------------------------------------------------------------------
\begin{frame}
\ctitle{RESULTADOS Y COMPARATIVAS}
\vspace{-4mm}
...
\begin{center}
  \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] (qzimg) at (0,0)
      {\includegraphics[width=0.85\linewidth,keepaspectratio]{fig_qz_zonas.png}};
    ...
    \end{scope}
  \end{tikzpicture}\\[3mm]
  {\small Figura 18: $q_z$ por zona --- 1971 (uniforme, $65{,}92$\,kgf/m$^2$) vs 2025 (zonificada).\\
  En Zona III-A: \alert{$51{,}00$\,kgf/m$^2$} ($-23\,\%$). Fuente: Elaboración propia.}
\end{center}
\end{frame}

%------------------------------------------------------------------
% 22b. VIENTO — PRESIONES COMPARATIVAS (tablas)
%------------------------------------------------------------------
\begin{frame}
\ctitle{RESULTADOS Y COMPARATIVAS}
\vspace{-4mm}
...
\vspace{3mm}
\begin{center}
{\footnotesize\textbf{Presión neta por superficie} (kgf/m$^2$):}\\[2mm]
{\footnotesize
\begin{tabular}{@{}lrrr@{}}
  \toprule
  ...
  \bottomrule
\end{tabular}}\\[4mm]
{\footnotesize\textbf{Succión en cubierta por zona} ($R = 2025/1971$):}\\[2mm]
{\footnotesize
\begin{tabular}{@{}lrrr@{}}
  \toprule
  Zona & 1971 & 2025 & $\Delta\,\text{\%}$ \\
  \midrule
  ...
  \bottomrule
\end{tabular}}\\[3mm]
{\footnotesize La 2025 \alert{intensifica} la succión de borde y \alert{alivia} la zona central.}
\end{center}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \begin{tabular}{@{}llrrrrl@{}}
    \toprule
    Grupo & Perfil & F.U. Instalado & F.U. Actualizado & $\Delta\,\text{\%}$ & Estado '25 & Combo controlante (2025) \\
    \midrule
