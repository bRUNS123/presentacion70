...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.0cm,keepaspectratio]%
    {fig04.png}\\[1mm]
  {\scriptsize Figura 18: Espectro de diseño NCh2369.Of2003\\(sitio de Maipú).\\ Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=5.0cm,keepaspectratio]%
    {fig05.png}\\[1mm]
  {\scriptsize Figura 19: Espectro de diseño NCh2369:2025.\\ Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  {\scriptsize Figura 20: Espectros NCh2369 Of.2003 vs 2025 generados a partir de los datos SAP2000.\\ Fuente: Elaboración propia.}
\end{columns}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wx.png}\\[1.5mm]
  {\scriptsize Figura 21: Cargas puntuales por marco --- viento $\perp$ cara corta ($W_x$); zonas Z1--Z4 según $h$.\\ Fuente: Elaboración propia.}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wy.png}\\[1.5mm]
  {\scriptsize Figura 22: Cargas distribuidas por marco --- viento $\perp$ cara larga ($W_y$); zonas NCh432:2025.\\ Fuente: Elaboración propia.}
\end{center}
\end{frame}
...
\begin{center}
  \begin{tikzpicture}
    ...
    \end{scope}
  \end{tikzpicture}\\[3mm]
  {\small Figura 23: $q_z$ por zona --- 1971 (uniforme, $65{,}92$\,kgf/m$^2$) vs 2025 (zonificada).\\
