...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \figcap{1}{Galpón industrial de acero\\(tipología de estudio)}{Elaboración propia}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \figcap{2}{Elevaciones planos de maestranza}{Elaboración propia}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=0.7\linewidth,height=\imghS,keepaspectratio]%
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \figcap{7}{Modelo de la Nave F (Metalpar)}{Elaboración propia}\\[2mm]
  \includegraphics[width=0.6\linewidth,height=\imghS,keepaspectratio]%
    {slide15_fig08.png}\\[1mm]
  \figcap{8}{Registro fotográfico - riostras y pilares}{Elaboración propia}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \figcap{9}{Planta construida (P2 en rojo)}{Elaboración propia}\\[0mm]
  \includegraphics[width=\linewidth,height=\imghS,keepaspectratio]%
    {slide16_fig10.png}\\[1mm]
  \figcap{10}{Elevación A-G (PT2 en rojo)}{Elaboración propia}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=\imghM,keepaspectratio]%
    {fig_lt01.png}\\[1mm]
  \figcap{11}{Sistema resistente identificado\\en terreno}{Elaboración propia}
  \column{0.55\textwidth}
  \vspace{1mm}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \vspace{1mm}
  \centering
  \includegraphics[width=0.9\linewidth,height=\imghS,keepaspectratio]%
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=\imghM,keepaspectratio]%
    {fig04.png}\\[1mm]
  \figcap{18}{Espectro de diseño NCh2369.Of2003\\(sitio de Maipú)}{Elaboración propia}
\end{columns}
\end{frame}
...
\begin{columns}[T,totalwidth=\textwidth]
  ...
  \includegraphics[width=\linewidth,height=\imghM,keepaspectratio]%
    {fig05.png}\\[1mm]
  \figcap{19}{Espectro de diseño NCh2369:2025}{Elaboración propia}
\end{columns}
\end{frame}
...
%------------------------------------------------------------------
\begin{frame}
\ctitlesub{RESULTADOS Y COMPARATIVAS}{Sismos - Espectros de diseño}
\begin{columns}[T,totalwidth=\textwidth]
  \column{0.45\textwidth}
  \vspace{-1mm}
  ...
  \figcap{20}{Espectros NCh2369 Of.2003 vs 2025 generados a partir de los datos SAP2000}{Elaboración propia}
\end{columns}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wx.png}\\[1.5mm]
  \figcap{21}{Cargas puntuales por marco --- viento $\perp$ cara corta ($W_x$); zonas Z1--Z4 según $h$}{Elaboración propia}
\end{center}
\end{frame}
...
\begin{center}
  \includegraphics[width=\linewidth,height=6.5cm,keepaspectratio]%
    {wind_Wy.png}\\[1.5mm]
  \figcap{22}{Cargas distribuidas por marco --- viento $\perp$ cara larga ($W_y$); zonas NCh432:2025}{Elaboración propia}
\end{center}
\end{frame}
...
%------------------------------------------------------------------
\begin{frame}
\ctitlesub{RESULTADOS Y COMPARATIVAS}{Viento - Zonificación y presiones}
\begin{center}
  \begin{tikzpicture}
    ...
    \end{scope}
  \end{tikzpicture}\\[3mm]
  \figcap{23}{$q_z$ por zona --- 1971 (uniforme, $65{,}92$\,kgf/m$^2$) vs 2025 (zonificada).\\
...
%------------------------------------------------------------------
\begin{frame}
\ctitlesub{RESULTADOS Y COMPARATIVAS}{Viento - Solicitaciones globales}
\begin{columns}[T,totalwidth=\textwidth]
  \column{0.48\textwidth}
  \vspace{-1mm}
...
%------------------------------------------------------------------
\begin{frame}
\ctitlesub{RESULTADOS Y COMPARATIVAS}{Casos y Combinaciones de Carga}
\begin{columns}[T,totalwidth=\textwidth]
  \column{0.48\textwidth}
  \vspace{-1mm}
...
%------------------------------------------------------------------
\begin{frame}
\ctitlesub{RESULTADOS Y COMPARATIVAS}{Sismo - Reacciones en la base}
\begin{columns}[T,totalwidth=\textwidth]
  \column{1.0\textwidth}
  \vspace{-1mm}
...
%------------------------------------------------------------------
\begin{frame}
\ctitlesub{RESULTADOS Y COMPARATIVAS}{Desplazamientos absolutos máximos (mm)}
\begin{columns}[T,totalwidth=\textwidth]
  \column{0.48\textwidth}
  \vspace{-1mm}
...
%------------------------------------------------------------------
\begin{frame}
\ctitlesub{RESULTADOS Y COMPARATIVAS}{Factor de utilización máximo (F.U.)}
\begin{columns}[T,totalwidth=\textwidth]
  \column{1.0\textwidth}
